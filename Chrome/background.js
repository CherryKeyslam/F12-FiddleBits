...
(info,tab) => {
  ...
  else if(info.menuItemId == "imprint") {
    chrome.tabs.sendMessage(tab.id, {command: "imprint"},function(response) {
      console.log('Operation success. Command sent and received: Imprint selection ');
    });
  }
});
